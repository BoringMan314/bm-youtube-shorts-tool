...
[Site](https://www.youtube.com/shorts/)
[GitHub](https://github.com/BoringMan314/bm-youtube-shorts-3x)
[License: MIT](LICENSE)
...
| 路徑                               | 說明                                 |
| -------------------------------- | ---------------------------------- |
| `[manifest.json](manifest.json)` | Manifest V3、`content_scripts` 與版本號 |
...
本擴充功能**不蒐集、不上傳**任何個人資料或瀏覽記錄；未使用任何分析工具或遠端程式碼。僅在本機頁面內操作影片播放速度。

**上架提醒**：若提交至 Chrome Web Store，須於後台填寫隱私實踐聲明；若需公開政策頁面，可透過 [GitHub Pages](https://pages.github.com/) 託管。
...
2. **封裝套件**：將專案內容壓縮為 ZIP 檔。
  - **必要檔案**：`manifest.json`, `content.js`, `content.css`, `LICENSE`。  
  - **排除檔案**：`.git/`, `.gitignore`, `README.md`, `*.zip`, `*.url`。
